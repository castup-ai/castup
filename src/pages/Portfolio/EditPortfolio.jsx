...
export default function EditPortfolio() {
    ...
    // Find existing portfolio for current user
    ...
    useEffect(() => {
        if (existingProfile) {
            setFormData({
                ...
                demoReel: existingProfile.demoReel || '',
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8 text-center">
                    <h1 className="text-4xl font-display font-bold mb-2">
                        Edit Your <span className="text-gradient">Portfolio</span>
                    </h1>
                    <p className="text-gray-400">Update your profile to keep it current and relevant</p>
                </div>
                    ...
                    <div className="space-y-6">
                        {aiSuggestions ? (
                            ...
                            <div className="glass-card p-6 text-center">
                                ...
                                <p className="text-gray-400 mb-4">Click "Get AI Suggestions" to receive personalized recommendations for your portfolio!</p>
                            </div>
                        )}
                    </div>
                </div>
